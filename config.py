TISSUE_DESCRIPTIONS = {
    "cardiac": (
        ...
        "that lasts 200-300 ms. This extended depolarization is due to slow Ca²⁺ channels 
    ...
    "neuron": (
        "Neuronal action potentials are rapid, lasting only 1-2 ms. They feature a sharp 
    ...
    "skeletal": (
        "Skeletal muscle action potentials have an intermediate duration of 2-5 ms. 
